...
class Digital_Asset_Manager {
	...
	private function define_admin_hooks() {
		...
		/** Create an instance of admin menu class */
		$admin_menu = new Digital_Asset_Manager_Admin_Menu( $this->get_plugin_name(), $this->get_version() );
		$this->loader->add_filter( 'set-screen-option', $admin_menu, 'set_screen', 50, 3 );
